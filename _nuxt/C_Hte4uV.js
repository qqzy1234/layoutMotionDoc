import{d as e,_ as p}from"./BCoQejXu.js";import{d as m,B as r,C as s,E as n,l as a,A as u,_ as f}from"./jQur5df3.js";const x={class:"px-12 py-14 max-w-4xl"},c={class:"mb-16"},y={class:"bg-[#f5f5f5] px-5 py-4 rounded-md"},g={class:"mb-16"},b={class:"bg-[#f5f5f5] px-5 py-4 rounded-md"},v={class:"bg-[#f5f5f5] px-5 py-4 rounded-md"},_=m({__name:"config",setup(C){const d=e(`
        // main.ts
