import{d as s,_ as i}from"./DrFQelrp.js";import{c as l}from"./WVBk0TGe.js";import{d as m,B as r,E as c,l as d,A as u}from"./DKMGnRlw.js";const x={class:"w-full h-full p-5"},p=m({__name:"code",props:{item:{default:()=>({})}},setup(t){const e=t,n=l(e.item,"",["content","size","color","borderWidth","type","gap","isTopStart","triggerIndex","customAni"],"                "),o=s(`
        <template>
