import{d as n,_ as m}from"./1p0rmulv.js";import{c as r}from"./WVBk0TGe.js";import{d as l,B as i,E as c,l as p,A as u}from"./CKw-aD2f.js";const d={class:"w-full h-full p-5"},f=l({__name:"code",props:{item:{default:()=>({})}},setup(t){const e=t,s=r(e.item,':isTrigger="item.attr.isTrigger"',["aniType","maskClass","alpha","duration"],"                "),a=n(`
        <template>
