import{d as o,_ as s}from"./BFzZqMGl.js";import{c as r}from"./WVBk0TGe.js";import{d as c,B as i,E as m,l as p,A as u}from"./BOn_v-DG.js";const d={class:"w-full h-full p-5"},f=c({__name:"code",props:{item:{default:()=>({})}},setup(t){const e=t,a=r(e.item,'class="h-70 w-full"',["imageUrl","bgMovDistance","enforceNoFixed","customAni"],"                "),l=o(`
        <template>
            <LM-bg-parallax
                ref="bgParallax"
                ${a}
