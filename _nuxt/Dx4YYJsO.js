import{d as o,_ as l}from"./BCoQejXu.js";import{c}from"./WVBk0TGe.js";import{d as i,B as r,E as m,l as d,A as p}from"./jQur5df3.js";const f={class:"w-full h-full p-5"},u=i({__name:"code",props:{item:{default:()=>({})}},setup(t){const e=t,n=c(e.item,':trigger="examplePanel"',["isReverse","instantReverse","aniType","customAni"],"                "),a=o(`
        <template>
