import{d as l,_ as c}from"./DrFQelrp.js";import{c as i}from"./WVBk0TGe.js";import{d as m,B as r,E as d,l as p,A as u}from"./DKMGnRlw.js";const f={class:"w-full h-full p-5"},g=m({__name:"code",props:{item:{default:()=>({})}},setup(t){const e=t,n=i(e.item,':trigger="examplePanel"',["isReverse","instantReverse","aniType","customAni"],"                "),a=()=>e.item.attr.customAni?`    const headChange = ref()
            const logo = ref()
