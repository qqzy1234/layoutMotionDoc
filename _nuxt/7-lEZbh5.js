import{d as s,_ as n}from"./1p0rmulv.js";import{c as i}from"./WVBk0TGe.js";import{d as l,B as d,E as m,l as c,A as u}from"./CKw-aD2f.js";const p={class:"w-full h-full p-5"},f=l({__name:"code",props:{item:{default:()=>({})}},setup(t){const e=t,o=i(e.item,"",["color","borderWidth","radius","type","startPoint","customAni","isTrigger"],"                "),r=s(`
        <template>
