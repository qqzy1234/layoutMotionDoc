import{d as o,_ as i}from"./BFzZqMGl.js";import{c as l}from"./WVBk0TGe.js";import{d as r,B as m,E as c,l as p,A as u}from"./BOn_v-DG.js";const d={class:"w-full h-full p-5"},f=r({__name:"code",props:{item:{default:()=>({})}},setup(t){const e=t,s=l(e.item,':isTrigger="item.attr.isTrigger"',["isTrigger","direction","diagonal","turns","axis","slotFollowFlip","customAni"],"                "),a=o(`
        <template>
