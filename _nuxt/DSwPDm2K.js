import{d as s,_ as i}from"./BCoQejXu.js";import{c as l}from"./WVBk0TGe.js";import{d as m,B as r,E as c,l as d,A as u}from"./jQur5df3.js";const x={class:"w-full h-full p-5"},p=m({__name:"code",props:{item:{default:()=>({})}},setup(t){const e=t,n=l(e.item,"",["content","size","color","borderWidth","type","gap","isTopStart","triggerIndex","customAni"],"                "),o=s(`
        <template>
