import{d as i,_ as a}from"./1p0rmulv.js";import{c as n}from"./WVBk0TGe.js";import{d as l,B as m,E as d,l as c,A as u}from"./CKw-aD2f.js";const p={class:"w-full h-full p-5"},f=l({__name:"code",props:{item:{default:()=>({})}},setup(t){const e=t,o=n(e.item,"",["color","borderWidth","radius","type","startPoint","customAni","isTrigger"],"                "),s=i(`
        <template>
