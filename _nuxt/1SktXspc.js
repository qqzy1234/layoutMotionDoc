import{d as l,_ as r}from"./1p0rmulv.js";import{c}from"./WVBk0TGe.js";import{d as n,B as a,E as i,l as m,A as d}from"./CKw-aD2f.js";const p={class:"w-full h-full p-5"},f=n({__name:"code",props:{item:{default:()=>({})}},setup(e){const t=c(e.item,'class="h-50"',["rows","rowHeight","gap"],"                "),s=l(`
        <template>
            <LM-row
                ${t}
            >
