import{d as n,_ as m}from"./BCoQejXu.js";import{c as r}from"./WVBk0TGe.js";import{d as i,B as c,E as l,l as d,A as u}from"./jQur5df3.js";const p={class:"w-full h-full p-5"},f=i({__name:"code",props:{item:{default:()=>({})}},setup(t){const e=t,s=r(e.item,':isTrigger="item.attr.isTrigger"',["maskMovDistance","direction","maskInitPos"],"                "),a=n(`
        <template>
