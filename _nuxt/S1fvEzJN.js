import{d as s,_ as a}from"./DrFQelrp.js";import{c}from"./WVBk0TGe.js";import{d as l,B as d,E as i,l as r,A as m}from"./DKMGnRlw.js";const p={class:"w-full h-full p-5"},u=l({__name:"code",props:{item:{default:()=>({})}},setup(e){const t=c(e.item,"",["columns","colWidth","gap"],"                "),o=s(`
        <template>
            <LM-column
                ${t}
            >
